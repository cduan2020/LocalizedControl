...
for i=1:nc
    ...
    Cset_aug0{i} = [Cset0{i} Cset0{i}+ng Cset0{i}+2*ng];
    Cset_aug{i} = [Cset{i} Cset{i}+ng Cset{i}+2*ng];
...
k=cell(nc,1);
parfor i=1:nc
    k{i}=DesignLocalContrl(AA{i},BB{i},QQ{i},RR{i},Cset_aug0{i},Cset_aug{i},bloc(i),3*ng);
